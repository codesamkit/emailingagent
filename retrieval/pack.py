...
def build_pack(
    *,
    ...
    # Sections accumulate locally and the pack is built once at the end:
    # ContextPack is frozen (models/schema.py), and total_chars is just
    # sum(len(section.text)) — deriving it here beats maintaining a second
    # running counter alongside `remaining` that could drift from sections.
